...
public class RowWebsocketClient implements RowClient {
    ...
    public void open() {
        ...
        RowMessageHandler rowMessageHandler = new RowMessageHandler(PipelineFactory.getPipeline(this.rowClientConfig), rowClientConfig.getConnectionRepository(), rowClientConfig.getClosePolicy(), rowClientConfig.getRowTransportListener(), this);
