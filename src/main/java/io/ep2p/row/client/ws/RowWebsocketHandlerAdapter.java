...
public class RowWebsocketHandlerAdapter extends Endpoint {
    ...
    private final io.ep2p.row.client.ws.MessageHandler<RowWebsocketSession> messageHandler;

    public RowWebsocketHandlerAdapter(RowWebsocketSession rowWebsocketSession, io.ep2p.row.client.ws.MessageHandler<RowWebsocketSession> messageHandler) {
